...
use nhockizi\translatemanager\bundles\TranslateManagerAsset;
...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
        ...
        <div class="wrap">
            <?php
            NavBar::begin([
                'brandLabel' => 'nhockizi TranslateManager',
        ...
        <footer class="footer">
            <div class="container">
                <p class="pull-left">&copy; nhockizi TranslateManager <?= date('Y') ?></p>
