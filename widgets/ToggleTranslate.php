...
namespace nhockizi\translatemanager\widgets;
...
class ToggleTranslate extends Widget {
     ...
     */
    public $frontendTranslationAsset = 'nhockizi\translatemanager\bundles\FrontendTranslationAsset';

    /**
     * example: http://www.yiiframework.com/doc-2.0/guide-structure-assets.html
     * @var string added JavaScripts and their dependencies
     */
    public $frontendTranslationPluginAsset = 'nhockizi\translatemanager\bundles\FrontendTranslationPluginAsset';
