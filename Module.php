...
namespace nhockizi\translatemanager;
 ...
 * 
 * 
 * @author Lajos Molnár <nhockizi.m@gmail.com>
 * @since 1.0
 */
class Module extends \yii\base\Module {
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'nhockizi\translatemanager\controllers';
    ...
    /**
     * @var string Regular expression to detect JavaScript nhockizi.t functions.
     * @deprecated since version 1.2.7
     */
    public $patternJs = '#nhockizi\.t\s*\(\s*(?P<text>\'.*?(?<!\\\\)\'|".*?(?<!\\\\)"?)\s*[,\)]#s';
     ...
     */
    public $jsTranslators = ['nhockizi.t'];
