<?php
namespace nhockizi\translatemanager\models;
...
class LanguageTranslate extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['id'], 'integer'],
            [['id'], 'exist', 'targetClass' => '\nhockizi\translatemanager\models\LanguageSource'],
            [['language'], 'exist', 'targetClass' => '\nhockizi\translatemanager\models\Language', 'targetAttribute' => 'language_id'],
            [['translation'], 'string'],
